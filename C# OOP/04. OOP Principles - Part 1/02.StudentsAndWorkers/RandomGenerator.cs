namespace _02.StudentsAndWorkers
{
    ...
    public static class RandomGenerator
    {
        ...
        public static int GenerateRandomIntegerNumber(int minNumber = 0, int maxNumber = int.MaxValue)
        {
            return RandomNumber.Next(minNumber, maxNumber);
        }

        public static double GenerateRandomFloatingPointNumber(int minNumber = 0, int maxNumber = int.MaxValue)
        {
            return (RandomNumber.Next(minNumber, maxNumber) + RandomNumber.NextDouble());
        }
