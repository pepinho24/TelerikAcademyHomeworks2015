...
namespace StudentTasks
{
    public static class RandomGenerator
    {
        ...
        public static int GenerateRandomNumber(int digitsCount = 7)
        {
            ...
            return random.Next(FNMin, FNMax + 1);
        }

        public static string GenerateRandomEmailDomain()
        {
            return EmailDomains[random.Next(0, EmailDomains.Length)];
        }

        public static int GenerateRandomMark(int minMark = 2, int maxMark = 6)
        {
            return random.Next(minMark, maxMark + 1);
        }

        public static string GenerateRandomTelephoneNumber()
        { 
            return (TelephoneNumberCodes[random.Next(0, TelephoneNumberCodes.Length)] + GenerateRandomNumber(random.Next(3,7)).ToString());
        }

        public static string[] TelephoneNumberCodes = new string[] { "+359", "+458", "+48", "+82", "+47", "02", "08", "015", "074" };
